...
create table portfoliotosymbol (id bigint identity primary key, portfolio_id bigint, symbol_id bigint, foreign key (portfolio_id) references portfolio(id), foreign key (symbol_id) references symbol(id));